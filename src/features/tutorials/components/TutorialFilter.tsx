...
import { TUTORIAL_CATEGORIES, type TutorialCategory } from '../types';
...
/**
 * Filter component for selecting tutorial categories.
 * Displays "All" plus each defined category as clickable buttons.
 */
export function TutorialFilter({ selectedCategory, onCategoryChange }: TutorialFilterProps) {
  return (
